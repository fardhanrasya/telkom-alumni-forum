...
type MenfessHandler struct {
	service  menfessService.MenfessService
	userRepo userRepo.UserRepository
}

func NewMenfessHandler(service menfessService.MenfessService, userRepo userRepo.UserRepository) *MenfessHandler {
	return &MenfessHandler{service: service, userRepo: userRepo}
}

func (h *MenfessHandler) CreateMenfess(c *gin.Context) {
	var req menfessDto.CreateMenfessRequest
