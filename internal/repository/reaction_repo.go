...
type ReactionRepository interface {
	...
	ToggleReaction(ctx context.Context, reaction *model.Reaction) (string, string, error)
...
func (r *reactionRepository) ToggleReaction(ctx context.Context, reaction *model.Reaction) (string, string, error) {
